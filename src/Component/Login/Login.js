...
import IconGG from "../../images/ic-google.png";
  ...
  render() {
    return (
      <div className="viewRoot">
        <div className="header login-page">+CloudChat</div>
        <p className="status">
          "Talking to your friends is sometimes all the therapy you need."
        </p>
        <button className="btnLogin" type="submit" onClick={this.onLoginPress}>
          <img src={IconGG} alt="IMG" />
          SIGN IN WITH GOOGLE
        </button>
